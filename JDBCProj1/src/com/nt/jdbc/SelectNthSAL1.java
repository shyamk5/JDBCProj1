...
/*
 * 	JDBC app to get Employee details whose having Nth highest salary using DENSE_RANK method (Analytical Functions)
 * 	Version :: 1.O
 * 	Author :: imshyam
 */
...
public class SelectNthSAL1 {
	...
	public static void main(String[] args) {
		...
		try {
			...
			String query = "SELECT * FROM (SELECT EMPNO,ENAME,JOB,SAL, DENSE_RANK()OVER(ORDER BY SAL DESC) R FROM EMP) WHERE R="+nth;
